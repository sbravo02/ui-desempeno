...
export default function CoordEvalFormClient() {
  ...
  function handleSubmit() { router.push("/coordinador/gracias"); }

  if (!prof) return <main className="p-6">Falta el parámetro del profesor.</main>;
